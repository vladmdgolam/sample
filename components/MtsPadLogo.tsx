interface MtsPadLogoProps {
  isDark?: boolean
}

export const MtsPadLogo: React.FC<MtsPadLogoProps> = ({ isDark = false }) => {
  const fillColor = isDark ? "#2D2D2D" : "#EBEBEB"
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix
            ...
            result="hardAlpha"
          />
          <feOffset dx="-2.71833" dy="-2.71833" />
          <feGaussianBlur stdDeviation="1.35916" />
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.736833 0 0 0 0 0.736833 0 0 0 0 0.736833 0 0 0 0.2 0"
          />
          <feBlend
            mode="normal"
            in2="effect1_innerShadow_27_46"
            result="effect2_innerShadow_27_46"
          />
        </filter>
        <filter
          id="filter1_ii_27_46"
